...
# Project Overview
This repository contains a data analysis pipeline and a Graphical User Interface (GUI) designed to analyse factors associated with diabetes. Using the Pima Indians Diabetes dataset, the system performs data cleaning, statistical auditing and interactive visualisation.
...
# Key Features:
-  Section 1-3 (data cleaning): Automated detection of invalid "0" entries in medical columns and treatment using Median Imputation.
-  Section 4 (Visual Analytics): Distribution plots, correlation heatmaps, and trend analysis using Seaborn and Matplotlib.
